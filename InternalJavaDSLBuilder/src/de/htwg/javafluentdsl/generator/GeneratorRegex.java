...
public class GeneratorRegex implements IGenerator{
	 ...
	 * Template paths
	 */
	private static final String REGEX_TEMPLATES_DIR_PATH = GeneratorUtil_StringTemplate.STRING_TEMPLATES_DIR_PATH
			+ "regex_templates/";
	...
	private static String regexGenerateModelInternDSL(
		...
		STGroup group = GeneratorUtil_StringTemplate.getStringTemplateFromPath(REGEX_TEMPLATES_DIR_PATH
				+ INTERN_BUILDER_FILE);
